            ...
            >
              ...
              {selectedList.length > 0 ? (
                ...
                <div className="mb-6 space-y-4">
                  ...
                  {/* ✅ CAMBIO APLICADO AQUÍ: Addons/Bonos con Flexbox robusto */}
                          ...
                          <li key={addon.id} className="flex justify-between items-start gap-4">
                            <label className="flex items-start gap-2 cursor-pointer text-sm">
                              <input
                                ...
                                className="form-checkbox h-5 w-5 mt-0.5 flex-shrink-0 accent-primary border-primary checked:accent-primary"
                              />
